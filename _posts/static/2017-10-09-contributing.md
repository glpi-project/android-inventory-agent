...
---
Welcome to our ever growing community! We are more than happy to accept external contributions to the Android Inventory Agent project in the form of feedback, [translations](#i-know-many-languages), bug reports and even better, pull requests!
...
Great! You can help us translating the project. We are currently translating to Korean, Spanish, French, Portuguese, Japanese and Russian. See our [How to Translate](http://flyve.org/android-inventory-agent/howtos/contribute-translating) guide to get started.
