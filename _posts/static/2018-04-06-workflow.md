...
layout: howtos
published: true
title: Android Inventory Agent Workflow
...
We keep our projects in repositories on [GitHub](https://github.com/glpi-project/), one of the biggest host of source code in the world, and use [Git](https://git-scm.com/) as our version control system.
