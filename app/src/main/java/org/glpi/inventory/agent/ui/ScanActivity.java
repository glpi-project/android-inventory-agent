...
import org.glpi.inventory.agent.utils.DialogBuilder;
...
public final class ScanActivity extends Activity implements TextureView.SurfaceTextureListener, ActivityCompat.OnRequestPermissionsResultCallback {
    public static final String INTENT_EXTRA_RESULT = "result";

    private static final long VIBRATE_DURATION = 50L;
    private static final long AUTO_FOCUS_INTERVAL_MS = 2500L;

    private final org.glpi.inventory.agent.utils.CameraManager cameraManager = new org.glpi.inventory.agent.utils.CameraManager();
    ...
    private final class AutoFocusRunnable implements Runnable {
        ...
        private AutoFocusRunnable(final Camera camera) {
            this.camera = camera;
        }
